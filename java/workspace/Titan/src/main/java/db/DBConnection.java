...
//	/**
//	 * Check if the item has been liked by user
//	 * @param userId
//	 * @param check_itemId
//	 * @return true if pair(user_id, item_id) exists in history; false otherwise
//	 */
//	public boolean isFavorite(String userId, String check_itemId);
