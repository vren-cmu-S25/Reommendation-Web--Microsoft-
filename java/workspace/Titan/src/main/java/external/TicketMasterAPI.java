...
// TODO: Fix heart style in Favorite
public class TicketMasterAPI {
	private static final String URL = "https://app.ticketmaster.com/discovery/v2/events.json"; 
	private static final String DEFAULT_TERM = ""; // no restriction
	private static final String API_KEY = "mZ11iMk2xlOvvfaJFPtoM6fOaeEoouKU";
	
	public static List<Item>  search(double lat, double lon, String term) { 
...
//			if (!event.isNull("id")) {
//				boolean is_favorite = conn.isFavorite(user_id, event.getString("id"));
//				builder.setIs_Favorite(is_favorite);
//			}
	...
	private void queryAPI(double lat, double lon, String user_id) { 
	...
	public static void main(String[] args) {
		...
		// Houston, TX
		tmApi.queryAPI(29.682684, -95.295410, "1111");
	}
}
